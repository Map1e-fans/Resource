...
public interface ResourcesPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Ammunitions</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int VEHICLE__AMMUNITIONS = 1;
	 ...
	 * @ordered
	 */
	int SHIP__AMMUNITIONS = VEHICLE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int AMMUNITION_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int DRONE__AMMUNITIONS = VEHICLE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int DRONE__AMOUNT = VEHICLE__AMOUNT;
	 ...
	 * @ordered
	 */
	int CARRIER_AIRCRAFT__AMMUNITIONS = VEHICLE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int CARRIER_AIRCRAFT__AMOUNT = VEHICLE__AMOUNT;
	 ...
	 * @ordered
	 */
	int FRIGATE__AMMUNITIONS = SHIP__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int DESTROYER__AMMUNITIONS = SHIP__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int AIRCRAFT_CARRIER__AMMUNITIONS = SHIP__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int MISSILE__AMOUNT = AMMUNITION__AMOUNT;
	 ...
	 * @ordered
	 */
	int MISSILE__NAME = AMMUNITION__NAME;
	 ...
	 * @ordered
	 */
	int MISSILE_FEATURE_COUNT = AMMUNITION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SHELL__AMOUNT = AMMUNITION__AMOUNT;
	 ...
	 * @ordered
	 */
	int SHELL__NAME = AMMUNITION__NAME;
	 ...
	 * @ordered
	 */
	int TORPEDO__AMOUNT = AMMUNITION__AMOUNT;
	 ...
	 * @ordered
	 */
	int TORPEDO__NAME = AMMUNITION__NAME;
	 ...
	 * @ordered
	 */
	int RECONNAISSANCE__AMMUNITIONS = DRONE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int RECONNAISSANCE__AMOUNT = DRONE__AMOUNT;
	 ...
	 * @ordered
	 */
	int STRIKE__AMMUNITIONS = DRONE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int STRIKE__AMOUNT = DRONE__AMOUNT;
	 ...
	 * @ordered
	 */
	int TRANSPORT__AMMUNITIONS = DRONE__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int TRANSPORT__AMOUNT = DRONE__AMOUNT;
	 ...
	 * @ordered
	 */
	int FIGHTER__AMMUNITIONS = CARRIER_AIRCRAFT__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int FIGHTER__AMOUNT = CARRIER_AIRCRAFT__AMOUNT;
	 ...
	 * @ordered
	 */
	int RECON__AMMUNITIONS = CARRIER_AIRCRAFT__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int RECON__AMOUNT = CARRIER_AIRCRAFT__AMOUNT;
	 ...
	 * @ordered
	 */
	int HELICOPTER__AMMUNITIONS = CARRIER_AIRCRAFT__AMMUNITIONS;
	 ...
	 * @ordered
	 */
	int HELICOPTER__AMOUNT = CARRIER_AIRCRAFT__AMOUNT;
	...
	/**
	 * Returns the meta object for the attribute '{@link resources.Resources#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see resources.Resources#getName()
	 * @see #getResources()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link resources.Ammunition#getAmount <em>Amount</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Amount</em>'.
	 * @see resources.Ammunition#getAmount()
	 * @see #getAmmunition()
	 * @generated
	 */
	EAttribute getAmmunition_Amount();

	/**
	 * Returns the meta object for the attribute '{@link resources.Ammunition#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see resources.Ammunition#getName()
	 * @see #getAmmunition()
	 * @generated
	 */
	EAttribute getAmmunition_Name();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link resources.Vehicle#getAmmunitions <em>Ammunitions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Ammunitions</em>'.
	 * @see resources.Vehicle#getAmmunitions()
	 * @see #getVehicle()
	 * @generated
	 */
	EReference getVehicle_Ammunitions();

	/**
	 * Returns the meta object for the attribute '{@link resources.Vehicle#getAmount <em>Amount</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Amount</em>'.
	 * @see resources.Vehicle#getAmount()
	 * @see #getVehicle()
	 * @generated
	 */
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute AMMUNITION__AMOUNT = eINSTANCE.getAmmunition_Amount();
		 ...
		 * @generated
		 */
		EAttribute AMMUNITION__NAME = eINSTANCE.getAmmunition_Name();
		...
		/**
		 * The meta object literal for the '<em><b>Ammunitions</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference VEHICLE__AMMUNITIONS = eINSTANCE.getVehicle_Ammunitions();
