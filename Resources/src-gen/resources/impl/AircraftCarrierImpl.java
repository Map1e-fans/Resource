...
public class AircraftCarrierImpl extends ShipImpl implements AircraftCarrier {
	/**
	 * The cached value of the '{@link #getCarrieraircraft() <em>Carrieraircraft</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<CarrierAircraft> getCarrieraircraft() {
		if (carrieraircraft == null) {
			carrieraircraft = new EObjectContainmentEList<CarrierAircraft>(CarrierAircraft.class, this,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ResourcesPackage.AIRCRAFT_CARRIER__CARRIERAIRCRAFT:
			return ((InternalEList<?>) getCarrieraircraft()).basicRemove(otherEnd, msgs);
		}
