 ...
 * </p>
 * <ul>
 *   <li>{@link resources.impl.ResourcesImpl#getVehicles <em>Vehicles</em>}</li>
 *   <li>{@link resources.impl.ResourcesImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourcesImpl extends MinimalEObjectImpl.Container implements Resources {
	...
	public EList<Vehicle> getVehicles() {
		if (vehicles == null) {
			vehicles = new EObjectContainmentEList<Vehicle>(Vehicle.class, this, ResourcesPackage.RESOURCES__VEHICLES);
		}
		return vehicles;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.RESOURCES__NAME, oldName, name));
	}
