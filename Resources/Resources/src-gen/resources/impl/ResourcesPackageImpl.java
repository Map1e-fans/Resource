...
public class ResourcesPackageImpl extends EPackageImpl implements ResourcesPackage {
	 ...
	 * @generated
	 */
	public EAttribute getMissile_Status() {
		return (EAttribute) missileEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getVehicle_Ammunition() {
	...
	public void createPackageContents() {
		...
		createEAttribute(missileEClass, MISSILE__STATUS);
		...
		createEReference(vehicleEClass, VEHICLE__AMMUNITION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMissile_Status(), this.getStatus(), "status", null, 0, 1, Missile.class, !IS_TRANSIENT,
		...
		initEAttribute(getVehicle_Name(), ecorePackage.getEString(), "name", null, 0, 1, Vehicle.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVehicle_Ammunition(), this.getAmmunition(), null, "ammunition", null, 0, -1, Vehicle.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
