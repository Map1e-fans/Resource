...
public class AircraftCarrierItemProvider extends ShipItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResourcesPackage.Literals.AIRCRAFT_CARRIER__CARRIERAIRCRAFTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AircraftCarrier.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ResourcesPackage.Literals.AIRCRAFT_CARRIER__CARRIERAIRCRAFTS,
