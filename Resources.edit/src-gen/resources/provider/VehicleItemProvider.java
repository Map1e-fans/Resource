...
/**
 * This is the item provider adapter for a {@link resources.Vehicle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VehicleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Vehicle_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Vehicle_name_feature", "_UI_Vehicle_type"),
						ResourcesPackage.Literals.VEHICLE__NAME, true, false, false,
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Vehicle_amount_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Vehicle_amount_feature",
								"_UI_Vehicle_type"),
						ResourcesPackage.Literals.VEHICLE__AMOUNT, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResourcesPackage.Literals.VEHICLE__AMMUNITIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ResourcesPackage.VEHICLE__AMOUNT:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ResourcesPackage.VEHICLE__AMMUNITIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ResourcesPackage.Literals.VEHICLE__AMMUNITIONS,
				ResourcesFactory.eINSTANCE.createMissile()));

		newChildDescriptors.add(createChildParameter(ResourcesPackage.Literals.VEHICLE__AMMUNITIONS,
				ResourcesFactory.eINSTANCE.createShell()));

		newChildDescriptors.add(createChildParameter(ResourcesPackage.Literals.VEHICLE__AMMUNITIONS,
				ResourcesFactory.eINSTANCE.createTorpedo()));
	}
